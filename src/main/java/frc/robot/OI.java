...
public class OI {
    ...
    public OI() {
        leftJoystick = new Joystick(RobotMap.DS_USB.LEFT_STICK);
        rightJoystick = new Joystick(RobotMap.DS_USB.RIGHT_STICK);
        ...
        right8.whenPressed(new SwitchDriveDirection(DriveAssist.DriveDirection.HATCH));
        right9.whenPressed(new SwitchDriveDirection(DriveAssist.DriveDirection.CARGO));
    ...
    public double getJoystickX(int port) {
        switch (port) {
            case RobotMap.DS_USB.LEFT_STICK:
                return leftJoystick.getX();
            case RobotMap.DS_USB.RIGHT_STICK:
    ...
    private void initalizeJoystickButtons() {
        left1 = new JoystickButton(leftJoystick, RobotMap.JOYSTICK_BUTTONS.BTN1);
        left2 = new JoystickButton(leftJoystick, RobotMap.JOYSTICK_BUTTONS.BTN2);
        left3 = new JoystickButton(leftJoystick, RobotMap.JOYSTICK_BUTTONS.BTN3);
        left4 = new JoystickButton(leftJoystick, RobotMap.JOYSTICK_BUTTONS.BTN4);
        left5 = new JoystickButton(leftJoystick, RobotMap.JOYSTICK_BUTTONS.BTN5);
        left6 = new JoystickButton(leftJoystick, RobotMap.JOYSTICK_BUTTONS.BTN6);
        left7 = new JoystickButton(leftJoystick, RobotMap.JOYSTICK_BUTTONS.BTN7);
        left8 = new JoystickButton(leftJoystick, RobotMap.JOYSTICK_BUTTONS.BTN8);
        left9 = new JoystickButton(leftJoystick, RobotMap.JOYSTICK_BUTTONS.BTN9);
        left10 = new JoystickButton(leftJoystick, RobotMap.JOYSTICK_BUTTONS.BTN10);
        left11 = new JoystickButton(leftJoystick, RobotMap.JOYSTICK_BUTTONS.BTN11);

        right1 = new JoystickButton(rightJoystick, RobotMap.JOYSTICK_BUTTONS.BTN1);
        right2 = new JoystickButton(rightJoystick, RobotMap.JOYSTICK_BUTTONS.BTN2);
        right3 = new JoystickButton(rightJoystick, RobotMap.JOYSTICK_BUTTONS.BTN3);
        right4 = new JoystickButton(rightJoystick, RobotMap.JOYSTICK_BUTTONS.BTN4);
        right5 = new JoystickButton(rightJoystick, RobotMap.JOYSTICK_BUTTONS.BTN5);
        right6 = new JoystickButton(rightJoystick, RobotMap.JOYSTICK_BUTTONS.BTN6);
        right7 = new JoystickButton(rightJoystick, RobotMap.JOYSTICK_BUTTONS.BTN7);
        right8 = new JoystickButton(rightJoystick, RobotMap.JOYSTICK_BUTTONS.BTN8);
        right9 = new JoystickButton(rightJoystick, RobotMap.JOYSTICK_BUTTONS.BTN9);
        right10 = new JoystickButton(rightJoystick, RobotMap.JOYSTICK_BUTTONS.BTN10);
        right11 = new JoystickButton(rightJoystick, RobotMap.JOYSTICK_BUTTONS.BTN11);

        gamepadA = new JoystickButton(gamepad, RobotMap.GAMEPAD_BUTTONS.A);
        gamepadB = new JoystickButton(gamepad, RobotMap.GAMEPAD_BUTTONS.B);
        gamepadX = new JoystickButton(gamepad, RobotMap.GAMEPAD_BUTTONS.X);
        gamepadY = new JoystickButton(gamepad, RobotMap.GAMEPAD_BUTTONS.Y);
        gamepadRB = new JoystickButton(gamepad, RobotMap.GAMEPAD_BUTTONS.RB);
        gamepadLB = new JoystickButton(gamepad, RobotMap.GAMEPAD_BUTTONS.LB);
        gamepadBack = new JoystickButton(gamepad, RobotMap.GAMEPAD_BUTTONS.BACK);
        gamepadStart = new JoystickButton(gamepad, RobotMap.GAMEPAD_BUTTONS.START);
        gamepadLeftStickButton = new JoystickButton(gamepad, RobotMap.GAMEPAD_BUTTONS.L3);
        gamepadRightStickButton = new JoystickButton(gamepad, RobotMap.GAMEPAD_BUTTONS.R3);
    }
}
